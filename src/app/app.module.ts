...
import { MatToolbarModule, MatIconModule, MatSidenavModule, MatListModule, MatButtonModule, MatCardModule, MatTableModule, MatTooltipModule, MatProgressSpinnerModule } from '@angular/material';
...
const appRoutes: Routes = [
  ...
  { path: 'public/public-actividad/:email/:uid', component: PublicActividadComponent },
  { path: 'public/public-album/:email/:uid', component: PublicAlbumComponent },
